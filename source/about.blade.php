...
@section('body')
  @include('_partials.home.hero-section', [
    'imageSrc' => "{$page->baseUrl}assets/images/about/hero.png",
    'overlayGradient' => "linear-gradient(90deg, rgba(18,60,64,.96) 0%, rgba(18,60,64,.9) 33%, rgba(18,60,64,.72) 58%, rgba(18,60,64,.35) 100%)",
