...
(function () {
  ...
  navbarToggler.addEventListener("click", function () {
    var isExpanded = navbarToggler.classList.toggle("active");
  ...
  // ===== selector
  var selectorButton = document.querySelectorAll(".selector");
  selectorButton.forEach(function (elem) {
    var button = elem.querySelector("button");
    var submenu = elem.querySelector(".ud-submenu");
    button.addEventListener("click", function () {
      var isExpanded = submenu.classList.toggle("show");
    ...
    menuLinks.forEach(function (link, index) {
      link.addEventListener("keydown", function (e) {
        if (e.key === "ArrowDown") {
          e.preventDefault();
          var nextLink = menuLinks[index + 1] || menuLinks[0];
          nextLink.focus();
        } else if (e.key === "ArrowUp") {
          e.preventDefault();
          var prevLink = menuLinks[index - 1] || menuLinks[menuLinks.length - 1];
          prevLink.focus();
        } else if (e.key === "Escape") {
          e.preventDefault();
          submenu.classList.remove("show");
  ...
  if (footerContact) {
    var handleContactClick = function handleContactClick() {
      ...
      var contactLink = footerContact.getAttribute("data-contact-url");
      if (contactLink) {
    ...
    // Keyboard support
    footerContact.addEventListener("keydown", function (e) {
      if (e.key === "Enter" || e.key === " ") {
        e.preventDefault();
        handleContactClick();
      }
...
/******/ 	__webpack_require__.O(undefined, ["css/ud-styles"], () => (__webpack_require__("./source/_assets/js/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/ud-styles"], () => (__webpack_require__("./source/_assets/scss/ud-styles.scss")))
