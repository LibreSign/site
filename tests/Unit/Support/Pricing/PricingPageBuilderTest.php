...
final class PricingPageBuilderTest extends TestCase
{
    ...
    public function testBuildPrefersExactLocaleOverBaseLocaleMatch(): void
    {
        $viewModel = $this->builder->build($this->makeProducts([
            [
                'id' => 10,
                ...
                'attributes' => [
                    ['name' => 'Storage', 'values' => ['2 Gb']],
                    ['name' => 'LibreSign features', 'values' => ['Recurso PT']],
                ],
            ],
            [
                'id' => 11,
                ...
                'langSlug' => 'pt-br',
                'attributes' => [
                    ['name' => 'Storage', 'values' => ['3 Gb']],
                    ['name' => 'LibreSign features', 'values' => ['Recurso PT-BR']],
                ],
            ],
        ]), 'pt-BR', 'en-US');
        ...
        self::assertSame('Plano PT-BR', $entry['product']->title);
        self::assertSame('3 Gb', $entry['detailAttributes'][0]['values'][0]);
        self::assertSame('Recurso PT-BR', $entry['cardHighlights'][0]['label']);
    }
